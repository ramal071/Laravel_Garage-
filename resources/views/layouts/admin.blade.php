    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="register"><i class="fa fa-magic"></i> <span class="nav-label">Register</span><span class="label label-info float-right">62</span></a>
                </li>
                <li class="landing_link">
                    <a href="logout"><i class="fa fa-star"></i> <span class="nav-label">logout</span> <span class="label label-warning float-right">NEW</span></a>
                </li>
